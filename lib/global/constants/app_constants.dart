class AppConstants {
  ...
  static const String _host ='10.28.164.173';
  ...
  static const String registerHospitalEndpoint = '$_base/auth/register/hospital/';
  ...
  static const String doctorAppointmentsEndpoint = '$_base/appointments/doctor/mine/';
  ...
  static String rescheduleAppointment(int id) => '$_base/appointments/$id/reschedule/';
  static String payAppointment(int id)     => '$_base/appointments/$id/pay/';
  static String completeAppointment(int id)=> '$_base/appointments/$id/complete/';
  static String markNotificationRead(int id) => '$_base/notifications/$id/read/';
  static String patientEHR(int patientId, String section) => '$_base/ehr/patient/$patientId/$section/';
  static String labReportDetail(int id)    => '$_base/lab-reports/$id/';
  static String patientLabReports(int patientId) => '$_base/lab-reports/patient/$patientId/';
}